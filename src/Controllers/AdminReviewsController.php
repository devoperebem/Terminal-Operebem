...
class AdminReviewsController extends BaseController
{
    ...
    public function uploadAvatar(): void
    {
        ...
        try {
            ...
            // Use server-side MIME detection (not client-controlled $file['type'])
            ...
            // Safe extension from detected MIME (not client-supplied filename)
            $safeExts = ['image/jpeg' => 'jpg', 'image/jpg' => 'jpg', 'image/png' => 'png', 'image/webp' => 'webp'];
            $extension = $safeExts[$detectedMime] ?? 'jpg';
            $filename = 'review_avatar_' . bin2hex(random_bytes(8)) . '.' . $extension;
