        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="adminNavbar">
                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link <?= $is('/secure/adm/index') ?>" href="/secure/adm/index">Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link <?= $is('/secure/adm/users') ?>" href="/secure/adm/users">Usuários</a></li>
                    <li class="nav-item"><a class="nav-link <?= $is('/secure/adm/plans') ?>" href="/secure/adm/plans">Planos</a></li>
                    <li class="nav-item"><a class="nav-link <?= $is('/secure/adm/subscriptions') ?>" href="/secure/adm/subscriptions">Assinaturas</a></li>
                    <li class="nav-item"><a class="nav-link <?= $is('/secure/adm/admins') ?>" href="/secure/adm/admins">Admins</a></li>
                </ul>
                <div class="d-flex align-items-center mt-3 mt-lg-0">
                    <button class="btn btn-outline-danger btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#adminLogoutModal"><i class="fas fa-sign-out-alt me-1"></i>Sair</button>
                </div>
            </div>
            <?php endif; ?>
        </div>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="/subscription/manage"><i class="fas fa-crown me-2"></i>Minha Assinatura</a></li>
    ...
    <div class="offcanvas offcanvas-end d-lg-none" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
        ...
        <div class="offcanvas-body">
            ...
            <nav class="nav flex-column gap-1">
                ...
                <a class="nav-link px-3 py-2 rounded d-flex align-items-center" href="/subscription/manage">
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
          <div class="modal-content">
            <div class="modal-header border-0 pb-0">
              <h5 class="modal-title" id="adminLogoutModalLabel"><i class="fas fa-sign-out-alt me-2 text-danger"></i>Sair</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
            </div>
            <div class="modal-body">
              <p class="mb-0">Tem certeza que deseja encerrar sua sessão de administrador?</p>
            </div>
            <div class="modal-footer border-0 pt-0">
              <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cancelar</button>
              <form method="POST" action="/secure/adm/logout" class="d-inline">
                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token ?? '', ENT_QUOTES, 'UTF-8') ?>">
                <button type="submit" class="btn btn-danger btn-sm"><i class="fas fa-sign-out-alt me-1"></i>Sair</button>
              </form>
            </div>
          </div>
        </div>
