...
<div class="container my-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h4 mb-0"><i class="fas fa-headset me-2"></i>Tickets de Suporte (Admin)</h1>
  </div>
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-body">
          ...
          <form method="POST" action="/admin/support/create" class="row g-3">
      ...
      <div class="card mb-3" id="ticket-<?= $tid ?>">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mt-2">
            <form method="POST" action="/admin/support/close" class="m-0 p-0">
              <input type="hidden" name="csrf_token" value="<?= $csrf_token ?>">
            ...
            <form method="POST" action="/admin/support/reply" class="flex-grow-1">
              <input type="hidden" name="csrf_token" value="<?= $csrf_token ?>">
              <input type="hidden" name="ticket_id" value="<?= $tid ?>">
              <div class="mb-2">
    ...
    <div class="tab-pane fade" id="tab-closed" role="tabpanel">
      ...
      <div class="card mb-3" id="ticket-<?= $tid ?>">
        ...
        <div class="card-body">
          ...
          <form method="POST" action="/admin/support/reopen" class="mt-2">
            <input type="hidden" name="csrf_token" value="<?= $csrf_token ?>">
            <input type="hidden" name="ticket_id" value="<?= $tid ?>">
