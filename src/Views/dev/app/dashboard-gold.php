<?php
$title = 'Dashboard Ouro - Terminal Operebem [TESTE]';
...
<div class="alert alert-warning m-3 text-center fw-bold shadow-sm" style="background: linear-gradient(135deg, #ff6b6b 0%, #feca57 100%); color: #000; border: 3px solid #ff3838; border-radius: 12px;">
