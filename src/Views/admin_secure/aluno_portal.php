...
<div class="container py-4">
  ...
  <div class="alert alert-info mb-3" role="alert">
    ...
    <strong>Pricing:</strong> Os planos e preços são gerenciados centralmente em <a href="/secure/adm/plans" class="alert-link">Planos &amp; Preços</a> do Terminal. A exibição no Portal do Aluno é configurada dentro de cada plano.
  </div>
