...
// PIN gate (before login)
$router->get('/secure/adm/pin', [AdminSecureController::class, 'pinForm']);
$router->post('/secure/adm/pin', [AdminSecureController::class, 'verifyPin'], [CsrfMiddleware::class]);
...
$router->get('/secure/adm/crm/view', [AdminSecureController::class, 'viewLead'], [SecureAdminMiddleware::class]);
$router->post('/secure/adm/crm/update', [AdminSecureController::class, 'updateLead'], [SecureAdminMiddleware::class, CsrfMiddleware::class]);
$router->post('/secure/adm/crm/interaction', [AdminSecureController::class, 'addLeadInteraction'], [SecureAdminMiddleware::class, CsrfMiddleware::class]);
...
$router->post('/secure/adm/users/logout-all-devices', [\App\Controllers\AdminSecureController::class, 'logoutAllDevices'], [SecureAdminMiddleware::class, CsrfMiddleware::class]);
...
// Plan Front Display (admin CRUD)
$router->post('/secure/adm/plans/front-display/save', [\App\Controllers\Admin\SubscriptionPlansAdminController::class, 'saveFrontDisplay'], [SecureAdminMiddleware::class, CsrfMiddleware::class]);

// Public API: Plan Front Display (for satellite systems)
$router->get('/api/plans/front-display', [\App\Controllers\Api\PlanFrontDisplayApiController::class, 'index']);
...
// Secure Admin - CDN Management
$router->get('/secure/adm/cdn', [\App\Controllers\AdminCdnController::class, 'index'], [SecureAdminMiddleware::class]);
$router->post('/secure/adm/cdn/upload', [\App\Controllers\AdminCdnController::class, 'upload'], [SecureAdminMiddleware::class, CsrfMiddleware::class]);
$router->post('/secure/adm/cdn/delete', [\App\Controllers\AdminCdnController::class, 'delete'], [SecureAdminMiddleware::class, CsrfMiddleware::class]);
$router->post('/secure/adm/cdn/cleanup', [\App\Controllers\AdminCdnController::class, 'cleanup'], [SecureAdminMiddleware::class, CsrfMiddleware::class]);
$router->post('/secure/adm/cdn/token', [\App\Controllers\AdminCdnController::class, 'generateToken'], [SecureAdminMiddleware::class, CsrfMiddleware::class]);
