...
$output .= "=== BRENT (8833) ===\n";
foreach ($r1 as $r) {
    $output .= json_encode($r, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT) . "\n";
}
...
$output .= "NOW: " . time() . " (" . date('Y-m-d H:i:s') . ")\n";

// Gravar em arquivo para fácil visualização
file_put_contents(__DIR__ . '/debug_resultado.txt', $output);
echo "Resultado gravado em debug_resultado.txt\n";
echo $output;
