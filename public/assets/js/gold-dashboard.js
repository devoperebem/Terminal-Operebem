  ...
  function renderFuturesGrid(items, avg, miners) {
    try {
      ...
      (miners || []).forEach(function (item) {
        ...
        minersData.push({
          code: code,
          item: item, // Guardar item original para timestamp
          pct: pct,
          price: price,
          nome: nome,
          nominalChange: nominalChange
      ...
      var htmlFutures = '<div class="card h-100 mb-4">'
        ...
        + '<div class="col-md-5 mb-3 mb-md-0">' // Aumentado para col-5 para caber a hora
      ...
      htmlFutures += '</tbody></table></div>'
        ...
        + '<div class="col-md-7">' // Reduzido para col-7
        + '<div class="row">'
        + '<div class="col-12 mb-2">'
        + '<canvas id="gc_futures_curve" style="height: 120px; width: 100%;"></canvas>'
        + '</div>'
        + '<div class="col-12">'
        + '<canvas id="gc_futures_chart" style="height: 120px; width: 100%;"></canvas>'
        + '</div>'
        + '</div>'
        + '</div>'
