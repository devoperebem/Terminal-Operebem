...
(function(){
    ...
    function segmentsFor(mk, targetOffset) {
        ...
        // Mesclar apenas segmentos adjacentes normais (não wraparound)
        if (segs.length > 1) {
            ...
            for (let i = 1; i < segs.length; i++) {
                ...
                // mas não atravessa meia-noite (evitar mesclar [1400,1440] com [0,60])
                if (Math.abs(next[0] - current[1]) <= 1 && next[0] < 1440 && current[1] < 1440) {
